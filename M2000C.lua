...
definePotentiometer("VOR/ILS_VOL_KNOB", 16, 3701, 701, {0, 1}, "AUDIO PANEL", "I - VOR/ILS Volume Knob")
...
definePotentiometer("V/UHF_RADIO_VOL_KNOB", 16, 3707, 707, {0, 1}, "AUDIO PANEL", "I - U/VHF - Radio Volume Knob")
...
defineBcdWheel("ALT_10K_FT_SEL", 0, 299, nil, "AUTOPILOT", "I - BCD - Altitude 10000 ft Selector")
defineBcdWheel("ALT_1K_FT_SEL", 0, 300, nil, "AUTOPILOT", "I - Altitude 1000 ft Selector")
defineBcdWheel("ALT_100_FT_SEL", 0, 301, nil, "AUTOPILOT", "I - Altitude 100 ft Selector")
...
defineToggleSwitch("ECS_COND_SW", 0, 3635, 635, "ECS PANEL", "I - ECS Cond Switch")
defineToggleSwitch("ECS_AIR_EXCH_SW", 0, 3636, 636, "ECS PANEL", "I - ECS Air Exchange Switch")
defineRotary("ECS_TEMP_SELECT_KNOB", 0, 3637, 637, "ECS PANEL", "I - ECS Temperature Select Knob")
...
defineBcdWheel("BINGO_FUEL_1K_KG_SEL", 0, 360, nil, "FUEL SYSTEM", "I - Bingo Fuel 1000 kg Selector")
defineBcdWheel("BINGO_FUEL_100_KG_SEL", 0, 361, nil, "FUEL SYSTEM", "I - Bingo Fuel 100 kg Selector")
defineToggleSwitch("FUEL_DMP_SW_COV", 0, 3477, 477, "FUEL SYSTEM", "I - FUEL - Dump Switch Cover")
defineToggleSwitch("FUEL_DMP_SW", 0, 3478, 478, "FUEL SYSTEM", "I - FUEL - Dump Switch")
...
defineToggleSwitch("RAD_IFF_L/R_SEL", 11, 3599, 599, "IFF", "I - IFF_INT -  L/R Selector")
defineBcdWheel("RAD_IFF_CODE-4_SEL", 11, 601, nil, "IFF", "I - IFF_INT -  Code-4 Selector")
defineBcdWheel("RAD_IFF_CODE-3_SEL", 11, 602, nil, "IFF", "I - IFF_INT -  Code-3 Selector")
defineBcdWheel("RAD_IFF_CODE-2_SEL", 11, 603, nil, "IFF", "I - IFF_INT -  Code-2 Selector")
defineBcdWheel("RAD_IFF_CODE-1_SEL", 11, 604, nil, "IFF", "I - IFF_INT -  Code-1 Selector")
defineToggleSwitch("NWS/IFF_INTERR_BTN", 22, 3807, 807, "IFF", "I - IFF_INT - Nose Wheel Steering / IFF Interrogation Button")
defineBcdWheel("MODE-1_10_SEL", 0, 377, nil, "IFF", "I - IFF_REP - Mode-1 Tens Selector")
defineBcdWheel("MODE-1_1_SEL", 0, 378, nil, "IFF", "I - IFF_REP - Mode-1 Ones Selector")
defineBcdWheel("MODE-3A_1K_SEL", 0, 379, nil, "IFF", "I - IFF_REP - Mode-3A Thousands Selector")
defineBcdWheel("MODE-3A_100_SEL", 0, 380, nil, "IFF", "I - IFF_REP - Mode-3A Hundreds Selector")
defineBcdWheel("MODE-3A_10_SEL", 0, 381, nil, "IFF", "I - IFF_REP - Mode-3A Tens Selector")
defineBcdWheel("MODE-3A_1_SEL", 0, 382, nil, "IFF", "I - IFF_REP - Mode-3A Ones Selector")
defineToggleSwitch("IDENT_PWR_SW", 0, 3383, 383, "IFF", "I - IFF_REP - Ident Power Switch")
defineToggleSwitch("MODE-1_SW", 0, 3384, 384, "IFF", "I - IFF_REP - Mode-1 Switch")
defineToggleSwitch("MODE-2_SW", 0, 3385, 385, "IFF", "I - IFF_REP - Mode-2 Switch")
defineToggleSwitch("MODE-3A_SW", 0, 3386, 386, "IFF", "I - IFF_REP - Mode-3A Switch")
defineToggleSwitch("MODE-C_SW", 0, 3387, 387, "IFF", "I - IFF_REP - Mode-C Switch")
...
definePotentiometer("LGT_BRIGHT_CTRL/TEST", 16, 3575, 575, {0, 1}, "INT LIGHTS", "I - Light Brightnes Control/Test")
...
definePotentiometer("CAUT/ADV_LGT", 16, 3643, 643, {0, 1}, "INT LIGHTS", "I - Caution/Advisory Lights Rheostat")
...
defineToggleSwitch("A/B_EMER_CUTOFF_SW_COV", 0, 3471, 471, "LEFT CONSOLE", "I - A/B Emergency Cutoff Switch Cover")
defineToggleSwitch("A/B_EMER_CUTOFF_SW", 0, 3472, 472, "LEFT CONSOLE", "I - A/B Emergency Cutoff Switch")
defineToggleSwitch("SEC_HUILE_SW_COVER", 0, 3473, 473, "LEFT CONSOLE", "I - Secours Huile Switch Cover")
defineToggleSwitch("SEC_HUILE_SW", 0, 3474, 474, "LEFT CONSOLE", "I - Secours Huile Switch")
defineToggleSwitch("ENG_EMER_CTRL_COV", 0, 3475, 475, "LEFT CONSOLE", "I - Engine Emergency Control Cover")
defineToggleSwitch("ENG_EMER_CTRL_SW", 0, 3476, 476, "LEFT CONSOLE", "I - Engine Emergency Control Switch")
defineToggleSwitch("FBW_CH_5_SW_COV", 0, 3479, 479, "LEFT CONSOLE", "I - FBW - Channel 5 Switch Cover")
defineToggleSwitch("FBW_CH_5_SW", 0, 3480, 480, "LEFT CONSOLE", "I - FBW - Channel 5 Switch")
...
defineToggleSwitch("NWS/IFF_INTERR_BTN", 22, 3807, 807, "MISCELANEOUS", "I - Nose Wheel Steering / IFF Interrogation Button")
...
defineMultipositionSwitch("CNPY_LK/N/LOW_LEV", 14, 3656, 656, 3, 0.5, "MISCELANEOUS", "I - Canopy Lock/Neutral/Lower Lever")
...
defineToggleSwitch("OFFSET_WP/TGT", 9, 3576, 576, "PCN", "I - PCN - Offset Waypoint/Target (BAD)")
...
defineString("PCN_DISP_DEST", getPCNDispDest, 9, "PCN", "O - PCN - DEST Display")
defineString("PCN_DISP_L", getPCNDispL, 9, "PCN", "O - PCN - Left Display")
defineString("PCN_DISP_PREP", getPCNDispPrep, 9, "PCN", "O - PCN - PREP Display")
...
definePushButton("AUTO/MAN_BTN", 6, 3269, 269, "PPA", "I - PPA - AUTO/MAN Button")
...
defineToggleSwitch("RAD_WOW_EM_AUT_SW", 0, 3470, 470, "RADAR", "I - Radar WOW Emitter Authorize Switch")
...
defineToggleSwitch("A/G_RAD_A_MODE_SW", 11, 3491, 491, "RADAR", "I - A/G Radar A Mode Switch")
defineToggleSwitch("A/G_RAD_DEC_MODE_SW", 11, 3493, 493, "RADAR", "I - A/G Radar DEC Mode Switch")
defineToggleSwitch("A/G_RAD_VISU_MODE_SW", 11, 3495, 495, "RADAR", "I - A/G Radar VISU Mode Switch")
...
definePushButton("A/A_RAD_STT_SEL_BTN", 11, 3504, 504, "RADAR", "I - A/A Radar STT Selector Button")
...
defineToggleSwitch("PITOT_HEAT_SW", 0, 3660, 660, "RIGHT CONSOLE", "I - Pitot Heat Switch")
...
defineMultipositionSwitch("INS_AUX_HD/HOR", 9, 3665, 665, 3, 0.5, "RIGHT CONSOLE", "I - INS Auxiliary Heading/Horizon")
...
defineToggleSwitch("TAC_X/Y_SEL", 23, 3624, 624, "TACAN", "I - TACAN X/Y Select")
...
defineTumb("U/VHF_10_M_SEL", 19, 3441, 441, 0.1, {0, 1}, nil, true, "U/VHF RADIO", "I - UVHF - 10 MHz Selector")
defineTumb("U/VHF_1_M_SEL", 19, 3442, 442, 0.1, {0, 1}, nil, true, "U/VHF RADIO", "I - UVHF - 1 MHz Selector")
defineTumb("U/VHF_100_K_SEL", 19, 3443, 443, 0.1, {0, 1}, nil, true, "U/VHF RADIO", "I - UVHF - 100 KHz Selector")
defineTumb("U/VHF_MODE_SW_1", 19, 3446, 446, 0.25, {0, 1}, nil, false, "U/VHF RADIO", "I - UVHF - Mode Selector")
defineTumb("U/VHF_M/P/G_SEL", 19, 3448, 448, 0.5, {0, 1}, nil, false, "U/VHF RADIO", "I - UVHF - M/P/G Selector")
defineTumb("U/VHF_100_M_SEL", 19, 3440, 440, 0.1, {0.1, 0.3}, nil, true, "U/VHF RADIO", "I - UVHF - 100 MHz Selector")
defineTumb("U/VHF_25_K_SEL", 19, 3444, 444, 0.1, {0.1, 0.3}, nil, true, "U/VHF RADIO", "I - UVHF - 25 KHz Selector")
defineToggleSwitch("U/VHF_TEST_SW", 19, 3437, 437, "U/VHF RADIO", "I - UVHF - TEST Switch")
defineToggleSwitch("U/VHF_SIL_SW", 19, 3439, 439, "U/VHF RADIO", "I - UVHF - SIL Switch")
defineBcdWheel("U/VHF_100_M_SEL", 19, 440, nil, "U/VHF RADIO", "I - UVHF - 100 MHz Selector")
defineBcdWheel("U/VHF_10_M_SEL", 19, 441, nil, "U/VHF RADIO", "I - UVHF - 10 MHz Selector")
defineBcdWheel("U/VHF_1_M_SEL", 19, 442, nil, "U/VHF RADIO", "I - UVHF - 1 MHz Selector")
defineBcdWheel("U/VHF_100_K_SEL", 19, 443, nil, "U/VHF RADIO", "I - UVHF - 100 KHz Selector")
defineBcdWheel("U/VHF_25_K_SEL", 19, 444, nil, "U/VHF RADIO", "I - UVHF - 25 KHz Selector")
defineSetCommandTumb("U/VHF_PRESET_KNOB", 19, 3445, 445, 0.05, {0.05, 1}, nil, true, "U/VHF RADIO", "I - UVHF - Preset Knob")
defineToggleSwitch("U/VHF_PWR_5W/25W_SW", 19, 3447, 447, "U/VHF RADIO", "I - UVHF - Power 5W/25W Switch")
defineTumb("U/VHF_E+A2_SW", 19, 3438, 438, 1, {-1, 1}, nil, false, "U/VHF RADIO", "I - UVHF - E+A2 Switch")
...
defineToggleSwitch("UHF_PWR_5W/25W_SW", 20, 3429, 429, "UHF RADIO", "I - UHF - Power 5W/25W Switch")
...
defineSetCommandTumb("UHF_PRESET_KNOB", 20, 3435, 435, 0.05, {0.05, 1}, nil, true, "UHF RADIO", "I - UHF - Preset Knob")
...
defineBcdWheel("VOR/ILS_FREQ_WHOLE", 24, 616, nil, "VOR / ILS", "I - VOR/ILS Frequency Change Whole")
defineToggleSwitch("VOR/ILS_PWR_DIAL", 24, 3617, 617, "VOR / ILS", "I - VOR/ILS Power Dial")
defineBcdWheel("VOR/ILS_FREQ_DECIMAL", 24, 618, nil, "VOR / ILS", "I - VOR/ILS Frequency Change Decimal")
defineToggleSwitch("VOR/ILS_TEST_DIAL", 24, 3619, 619, "VOR / ILS", "I - VOR/ILS Test Dial")
...
defineToggleSwitch("A/G_GUN_RET_SW", 5, 3208, 208, "VTH", "I - HUD - A/G Gun Reticle Switch")
